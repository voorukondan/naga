...
import com.example.example.school.repository.StudentRepository;
...
try {
Student student = db.queryForObject("select * from student where student where studentId = ?",new StudentRowmapper(), studentId);
return student;
} catch (Exception e) {
